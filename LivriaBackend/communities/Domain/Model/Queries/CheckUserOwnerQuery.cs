...
{
    /// <summary>
    /// Consulta utilizada para verificar si un usuario de tipo cliente específico es dueño de una comunidad específica.
    /// </summary>
    ...
    public record CheckUserOwnerQuery(int UserClientId, int CommunityId);
}